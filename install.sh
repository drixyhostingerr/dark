...
#########################
CDNF="https://raw.githubusercontent.com/drixyhostingerr/dark/"
...
echo ""
wget -q https://raw.githubusercontent.com/drixyhostingerr/dark/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
   ...
   clear
    ...
    sleep 2
CHATID="6360618203"
KEY="6607080497:AAFfrCKSMITbG9BUqvK0-lpoJORM0G-VAes"
WKT="10"
URL="https://api.telegram.org/bot$KEY/sendMessage"
TEXT="Project DrixyHostinger 2020
============================
...
sleep 2
clear
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
echo -e "$green[INFO]$NC INSTALL SLOWDNS"
sleep 2
wget https://raw.githubusercontent.com/drixyhostingerr/dark/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/drixyhostingerr/dark/main/version  )
...
echo " "
echo "=====================-[ AutoScript Drixy-Hostinger Project ]-===================="
echo ""
echo "------------------------------------------------------------"
echo ""
echo ""
...
echo ""  | tee -a log-install.txt
echo "   >>> WhatsApp : +6285173173554 (Text Only)"  | tee -a log-install.txt
echo "   >>> Telegram : t.me/DrixyHosting"  | tee -a log-install.txt
echo ""
echo ""
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Drixy-Hostinger  ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
...
echo -e "
"
echo -ne "[ ${yell}WARNING${NC} ] apakah anda mau mereboot nya ? (yes/no)? "
read answer
