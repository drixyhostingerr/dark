...
UPDATE="https://raw.githubusercontent.com/drixyhostingerr/dark/main/update/update.sh"
...
echo -e "  ${BLUE}• ${GREEN}Clients Name        ${NC}: ${YELLOW}SUPER LTS ${NC}"
echo -e "  ${BLUE}• ${GREEN}Script Exfire       ${NC}: ${YELLOW}1(${NC}${RED}Hari ${NC}${YELLOW})${NC}"
...
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "         << AUTOSCRIPT PREMIUM DrixyHostinger 2020>>                    \E[0m"
echo -e "$COLOR1└────────────────────────────────────────────────────────────┘${NC}"
echo -e ""
