#!/bin/bash
# =========================================
BOT="https://raw.githubusercontent.com/drixyhostingerr/dark/"
UPDATE="https://raw.githubusercontent.com/drixyhostingerr/dark/main/update.sh"
...
data_ip="https://raw.githubusercontent.com/drixyhostingerr/dark/main/permission/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/drixyhosting
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6285173173554"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
Exp=$(curl -sS https://raw.githubusercontent.com/drixyhostingerr/dark/main/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "  ${BLUE}• ${GREEN}Operating System    ${NC}: $(grep -w "PRETTY_NAME" /etc/os-release | sed 's/PRETTY_NAME="//;s/"//') ( $(uname -m) )"
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}: DrixyHostinger 2020 ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
